...
require_once TEMPLATEPATH . '/functions/sgpanel/modules/sgp-config.php';
...
function sg_term()
{
	...
	if (strpos($uri, _sg('General')->getPortfolioCSlug()) > 0 OR strpos($uri, _sg('General')->getPortfolioTSlug()) > 0) return 'portfolio';
}