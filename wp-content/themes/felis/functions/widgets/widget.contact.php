...
class SG_Widget_Contact extends WP_Widget {
	...
	function widget( $args, $instance ) {
		extract($args);
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? __('Contact Us', SG_TDN) : $instance['title'], $instance, $this->id_base );
		$phone = apply_filters( 'widget_text', $instance['phone'], $instance );
		$email = apply_filters( 'widget_text', $instance['email'], $instance );
		$address = apply_filters( 'widget_text', $instance['address'], $instance );
		echo $before_widget;
