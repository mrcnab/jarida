...
/* Widgets */
require_once TEMPLATEPATH.'/functions/widgets/widget.contact.php';
require_once TEMPLATEPATH.'/functions/widgets/widget.flickr.php';
require_once TEMPLATEPATH.'/functions/widgets/widget.twitter.php';
require_once TEMPLATEPATH.'/functions/widgets/widget.pcategories.php';
require_once TEMPLATEPATH.'/functions/widgets/widget.ptagcloud.php';
