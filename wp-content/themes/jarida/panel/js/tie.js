...
// HomeBuilder
	...
	jQuery(".tie_add-divider").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head divider"> Divider <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div class="widget-content" style="display:block"><label for="tie_home_cats'+builderno+'[<?php echo jQueryi ?>][height]"><span>Height :</span><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="divider" type="hidden" />  <input id="tie_home_cats'+builderno+'['+ nextCell +'][height]" name="tie_home_cats'+builderno+'['+ nextCell +'][height]" value="10" type="text" style="width:50px;" /> px</label>  <a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
	...
	jQuery(".tie_add-ads").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head">  ADS <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div class="widget-content" style="display:block"><textarea name="tie_home_cats'+builderno+'['+ nextCell +'][text]" id="tie_home_cats'+builderno+'['+ nextCell +'][text]"></textarea><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="ads" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
