...
# Save Method
/*-----------------------------------------------------------------------------------*/	
//add_action('admin_init', 'tie_theme_save_admin_init');
function tie_theme_save_admin_init(){
    register_setting(
        'general',                 // settings page
        'tie_theme_save'        // option name
    );
    
    add_settings_field(
        'tie_theme_save',  		    // id
        theme_name.' Save Settings Method',              // setting title
        'tie_theme_save',    // display callback
        'general',                 // settings page
...
function tie_theme_save() {
    $options = get_option( 'tie_theme_save' );
    $value = $options['tie_theme_save'];
?>
	
<select name="tie_theme_save" id="tie_theme_save">
	<option value="j">Ajax</option>
	<option <?php if( esc_attr( $value ) =='n' ) echo 'selected="selected"'; ?>value="n">Normal</option>
</select>
    <?php
}
