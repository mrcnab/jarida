	...
	<?php endif; ?>
			...
			<div class="tiepanel-item"  style=" overflow: visible; ">
				...
				<div class="option-item">
					...
					<div class="home-builder-buttons">
						...
						<a class="tie_add-ads" data-id="#cat_sortable" data-num="1">ADS</a>
						<a class="tie_add-news-picture" data-id="#cat_sortable" data-num="1">News in picrure</a>
							...
							if($cats){
								...
								<?php 
									elseif( $cat['type'] == 'recent' ) :	?>
										...
										<div class="widget-content">
											<label><span style="float:left;">Exclude This Categories : </span><select multiple="multiple" name="tie_home_cats1[<?php echo $i ?>][exclude][]" id="tie_home_cats1[<?php echo $i ?>][exclude][]">
												<?php foreach ($categories as $key => $option) { ?>
				...
				<div class="option-item">
					...
					<div class="home-builder-buttons">
						...
						<a class="tie_add-ads" data-id="#cat_sortable2" data-num="2" >ADS</a>
				...
				<div class="option-item">
					...
					<div class="home-builder-buttons">
						...
						<a class="tie_add-ads" data-id="#cat_sortable3" data-num="3">ADS</a>
				...
				<div class="option-item">
					...
					<div class="home-builder-buttons">
						...
						<a class="tie_add-ads" data-id="#cat_sortable4" data-num="4" >ADS</a>
		...
		<div id="tab11" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item" id="custom-sidebars">
				...
				foreach ($categories_obj as $pn_cat) {
					...
					if(tie_get_option( 'columns_num' ) != '2c'){
						tie_options(				
							array(	"name" => '<em><small>Category : </small></em> '.$pn_cat->cat_name.' - <strong>Narrow</strong>',
									"id" => "sidebar_narrow_cat_".$pn_cat->cat_ID,
									"type" => "select",
									"options" => $new_sidebars )); 	
					}
				}
		...
		<div id="tab16" class="tab_content tabs-wrap">
			<h2>Categories Design</h2> <?php echo $save; ?>
				...
				<div class="tiepanel-item">
					<h3>Apply the custom categories colors on the Homepage News boxes</h3>
					<?php
					tie_options(
						array(	"name" => "Apply on Homepage News boxes",
